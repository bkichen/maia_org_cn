	...
	$.fn.hScrollPane=function(settings){
		...
		this.each(function(){
			var container=$(this),
				...
				dragbar=(container.find(".hScrollPane_dragbar").length==0 && c>w ) ? container.append('<div class="hScrollPane_dragbar"></div>').find(".hScrollPane_dragbar") : container.find(".hScrollPane_dragbar"),
