function ScrollPlay03(options){
    var oPic = document.getElementById('pic03');
    var oPrev = document.getElementById('prev03');
    var oNext = document.getElementById('next03');
    var oCont01 = document.getElementById('cont03');
    var oImgList01 = document.getElementById('imgs_list03');
    var oImgList02 = document.getElementById('img_list04');
    var moveTimeObj01;
    ...
    var inits = {
        ...
        pageWidth01 : 1200,  //Movement Distance (px)
