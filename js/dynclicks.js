...
function _showDynClicks(clicktype, owner, clickid)
{
    try
    {
        ...
        var url = '/system/resource/bsites/click/dynclicks.jsp?bschoolid='+bsites_bschoolid+'&clickid='+clickid+'&owner='+owner+'&clicktype='+clicktype;
...
function _showDynClickBatch(spanids,wbnewsids,clicktype, owner)
{
		...
		try
		{
				var url = '/system/resource/bsites/click/dynclicksbatch.jsp?bschoolid='+bsites_bschoolid+'&clickids='+usernewsids+'&owner='+owner+'&clicktype='+clicktype;
...
function _addDynClicks(clicktype, owner, clickid)
{
    try
    {
    	var url = '/system/resource/bsites/click/bsites_addclicktimes.jsp?bschoolid='+bsites_bschoolid+'&wburlid=' + clickid + '&owner=' + owner + '&type=' + clicktype;
        var xmlhttp = _dynClicks_ajax();
        xmlhttp.open("GET",url, true);
        xmlhttp.send();
    }
