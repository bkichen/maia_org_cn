...
function _statistic_(bschoolid,btreeid, pagename, newsid)
{
    ...
    var r = '&e=1&w='+screen.width + '&h='+ screen.height+'&refer='+e.encode(document.referrer)+ '&pagename='+e.encode(pagename)+'&newsid='+newsid;
    _jsq_image.src = "/system/resource/bsites/datainput.jsp?bschoolid="+bschoolid+"&btreeid="+btreeid+ r;
}